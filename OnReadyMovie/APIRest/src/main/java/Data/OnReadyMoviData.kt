    ...
    private fun createUsers(): List<Pelicula> {
        ...
        return listOf(
            Pelicula("Malefica","https://static.pelisplus.me/movie/cover/original/9be31cf3f4c77ff9184cd68facad719e.jpg",
                    "La hada cornuda (Angelina Jolie) y la que pronto será la reina (Elle Fanning), ya que forman nuevas alianzas y se enfrentan a nuevos adversarios en su lucha por proteger a las criaturas mágicas que residen en su interior.","EEUU","01/05/2019","Robert Stromberg"),
